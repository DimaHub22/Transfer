  ...
  faqItems = [
    {
      ...
      highlight: 'Удобная форма оплаты'
    },
    {
    ...
    },
    {
      ...
      answer: 'Да, мы перевозим домашних животных. Пожалуйста, предупредите нас заранее при бронировании, указав вид и размер питомца. Крупных животных мы не перевозим. Животное должно находиться в переноске или на поводке.',
